...
const catalog: CatalogEntry[] = [
  { source: "Material", name: "3/4\" MDF Sheet", unitCost: 55, category: "Wood & Sheet Goods" },
  { source: "Material", name: "1.5\" Aluminum Extrusion, Exhibit Frame Grade", unitCost: 4.5, category: "Metal & Extrusion" },
  { source: "Rental", name: "Doors", unitCost: 150, category: "Structure" },
  { source: "Rental", name: "Frames", unitCost: 100, category: "Structure" },
  { source: "Rental", name: "Flooring — per square foot", unitCost: 4.9, category: "Flooring" },
];
...
describe("matchDescription", () => {
  it("matches a plural catalog name against a real RFP line description", () => {
    ...
    expect(match).toEqual({ source: "Rental", name: "Doors", unitCost: 150, category: "Structure" });
  });
