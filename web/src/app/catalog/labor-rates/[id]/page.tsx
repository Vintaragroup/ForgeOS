...
export default async function LaborRateDetailPage(props: PageProps<"/catalog/labor-rates/[id]">) {
  ...
  return (
    <div>
      <PageHeader title={rate.rateType === "DEPARTMENT" ? (rate.departmentName ?? "Labor rate") : (rate.city ?? "Labor rate")} />
      <Card className="p-6">
        ...
        <form action={deleteLaborRateWithId} className="mt-4 border-t border-neutral-200 pt-4">
